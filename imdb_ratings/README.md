...
This is a gem that scrapes IMDB for movie genres and allows you to select the 1 that you want to watch. Upon selection it will scrape from the top 50 current movies of that genre and present you with a list of: Movie title, Release year and Movie rating. The list is ordered from highest rating to lowest rating.
